...
let supply = calculateSupply(30, 3);
console.log(supply);
...
function shorterString(str1 , str1, str2 , str3 , str4 , str5){
  ...
  //  if ( str5.length < str1.length && str5.length < str2.length && str5.length < str3.length && str5.length < str4.length) 
   {
    return str5;
   }
      }
